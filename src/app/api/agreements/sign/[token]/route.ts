...
export async function GET(
  ...
  return NextResponse.json({
    ...
    // Section toggles (purchase agreement)
    include_equipment: agreement.include_equipment,
    include_location_services: agreement.include_location_services,
    include_shipping_storage: agreement.include_shipping_storage,
    location_services_deposit_only: agreement.location_services_deposit_only,
    location_services_deposit_amount: agreement.location_services_deposit_amount,

    // Location Placement Agreement
    location_business_name: agreement.location_business_name,
    location_contact_name: agreement.location_contact_name,
    location_contact_email: agreement.location_contact_email,
    location_contact_phone: agreement.location_contact_phone,
    location_contact_title: agreement.location_contact_title,
    location_address: agreement.location_address,
    location_city: agreement.location_city,
    location_state: agreement.location_state,
    location_zip: agreement.location_zip,
    placement_machine_count: agreement.placement_machine_count,
    placement_machine_type: agreement.placement_machine_type,
    placement_installation_date: agreement.placement_installation_date,
    placement_term_months: agreement.placement_term_months,
    placement_exclusivity: agreement.placement_exclusivity,
    placement_notes: agreement.placement_notes,
    commission_type: agreement.commission_type,
    commission_pct: agreement.commission_pct,
    commission_monthly_fee: agreement.commission_monthly_fee,
    commission_payout_schedule: agreement.commission_payout_schedule,
    commission_notes: agreement.commission_notes,
    placement_operator_company: agreement.placement_operator_company,
    placement_operator_contact: agreement.placement_operator_contact,
    placement_operator_email: agreement.placement_operator_email,
    placement_operator_phone: agreement.placement_operator_phone,
    include_placement_terms: agreement.include_placement_terms,
    include_compensation: agreement.include_compensation,
    include_duration_termination: agreement.include_duration_termination,
    include_responsibilities: agreement.include_responsibilities,
