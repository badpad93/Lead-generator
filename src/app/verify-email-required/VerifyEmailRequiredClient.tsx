...
export default function VerifyEmailRequiredClient({
  initialBrand,
}: {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
          ...
          <p className="text-sm text-black-primary/60 mb-6">
            {initialBrand
              ? `We need to confirm your email address before you can start ordering from ${initialBrand.display_name}.`
          ...
          <p className="mt-6 text-xs text-black-primary/40">
            Already verified? <Link href={loginHref} className="text-green-primary hover:underline">Sign in again</Link>.
          </p>
        </div>
      </div>
    </div>
