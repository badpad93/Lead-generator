...
function CallbackContent({ initialBrand }: { initialBrand: AuthBrand | null }) {
...
export default function CallbackClient({ initialBrand }: { initialBrand: AuthBrand | null }) {
  return (
    <Suspense
      fallback={
        <div className="min-h-[calc(100vh-160px)] flex flex-col items-center justify-center px-4">
    ...
    >
      <CallbackContent initialBrand={initialBrand} />
    </Suspense>
  );
}
