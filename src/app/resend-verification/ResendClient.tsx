...
function ResendContent({ initialBrand }: { initialBrand: AuthBrand | null }) {
...
export default function ResendClient({ initialBrand }: { initialBrand: AuthBrand | null }) {
  return (
    <Suspense fallback={null}>
      <ResendContent initialBrand={initialBrand} />
    </Suspense>
  );
}
