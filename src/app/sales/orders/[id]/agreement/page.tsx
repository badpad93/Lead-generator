...
export default function AgreementEditorPage() {
  ...
  async function handleSave() {
    ...
    const payload: Record<string, unknown> = {
      ...
      // All freight-rate fields track the single freight number, and
      // storage is always zeroed — every save repairs legacy rows
      // that still carry the phantom DB defaults ($500/$375/$50).
    ...
    <div className="p-6 max-w-7xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* ---- Shipping & Freight ----
              ONE freight number, inherited from the order's freight
              line. The old Standard/Discounted/Storage fields exposed
              DB-default rates ($500/$375/$50 per mo) that existed
              nowhere on the quote or order and leaked into the
              contract text. Storage is not a line item — if the
              storage program returns, it comes back via the item
              catalog. */}
          <div className="rounded-xl border border-gray-200 bg-white p-5">
            <h3 className="text-sm font-semibold text-gray-900 flex items-center gap-2 mb-4">
    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/60 p-4 sm:p-8">
      <div className="relative w-full max-w-4xl rounded-2xl bg-white shadow-2xl my-4">
        ...
        <div className="px-8 py-6 prose prose-sm max-w-none text-gray-800 leading-relaxed">
          ...
          <p>
            <strong>8. Shipping.</strong> Freight is ${currency(freightPer)} per machine, for a total shipping cost of{" "}
