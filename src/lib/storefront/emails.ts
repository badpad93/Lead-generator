...
export async function sendInvitationEmail(params: {
  ...
  const body = `
    ...
    <p style="margin:0 0 20px 0;color:#333;">Click below to accept — it takes about 30 seconds. Once you accept, your account is linked to ${escapeHtml(params.tenant.display_name)} and can only be transferred by an administrator.</p>
